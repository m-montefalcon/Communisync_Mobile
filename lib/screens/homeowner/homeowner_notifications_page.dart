...
import '../../backend/api/notification/notifications.dart'; // Alias the import

class HomeOwnerNotificationsPage extends StatefulWidget {
  const HomeOwnerNotificationsPage({Key? key}) : super(key: key);

  @override
  State<HomeOwnerNotificationsPage> createState() =>
      _HomeOwnerNotificationsPageState();
}

final GlobalKey<RefreshIndicatorState> _refreshIndicatorKey =
GlobalKey<RefreshIndicatorState>();

class _HomeOwnerNotificationsPageState
    extends State<HomeOwnerNotificationsPage> {
