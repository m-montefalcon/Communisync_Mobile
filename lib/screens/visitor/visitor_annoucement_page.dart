...
import '../../backend/api/homeowner/AF/fetch_announcements.dart';
import '../../backend/model/models.dart';
import '../../constants/custom_clipper.dart';
import '../homeowner/homeowner_announcements_specific_page.dart';

class VisitorAnnouncementPage extends StatefulWidget {
  const VisitorAnnouncementPage({super.key});

  @override
  State<VisitorAnnouncementPage> createState() => _VisitorAnnouncementPageState();
}

class _VisitorAnnouncementPageState extends State<VisitorAnnouncementPage> {
  @override
